...
public abstract class BaseLocationProvider implements LocationProvider {
  ...
  @Override
  public void getLocation(Map<String, Object> attributes,
    ...
    if (mcc != null && mnc != null && lac != null && cid != null) {
      getLocation(mcc.intValue(), mnc.intValue(), lac.longValue(),
          cid.longValue(), callback);
    }
    
  }
  
  protected abstract void getLocation(int mcc, int mnc, long lac, long cid,
      LocationProviderCallback callback);
