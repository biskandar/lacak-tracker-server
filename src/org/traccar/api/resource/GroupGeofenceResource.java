...
public class GroupGeofenceResource extends BaseResource {
  ...
  public Response add(GroupGeofence entity) throws SQLException {
    ...
    Context.getPermissionsManager()
        .checkGroup(getUserId(), entity.getGroupId());
    Context.getPermissionsManager().checkGeofence(getUserId(),
        entity.getGeofenceId());
    Context.getDataManager().linkGroupGeofence(entity.getGroupId(),
        entity.getGeofenceId());
  ...
  public Response remove(GroupGeofence entity) throws SQLException {
    ...
    Context.getPermissionsManager().checkGeofence(getUserId(),
        entity.getGeofenceId());
    Context.getDataManager().unlinkGroupGeofence(entity.getGroupId(),
        entity.getGeofenceId());
    Context.getGeofenceManager().refresh();
