...
public class ConsoleServlet extends WebServlet {
  ...
  public void init() {
    ...
    try {
      ...
      org.h2.server.web.WebServer server = (org.h2.server.web.WebServer) field
          .get(this);
      ...
      Method method = org.h2.server.web.WebServer.class.getDeclaredMethod(
          "updateSetting", ConnectionInfo.class);
