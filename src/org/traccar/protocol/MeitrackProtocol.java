...
public class MeitrackProtocol extends BaseProtocol {
  ...
  public MeitrackProtocol() {
    ...
    setSupportedCommands(Command.TYPE_POSITION_SINGLE,
        ...
        Command.TYPE_ALARM_ARM, Command.TYPE_ALARM_DISARM,
        Command.TYPE_REQUEST_PHOTO, Command.TYPE_SEND_SMS);
  }
  ...
  public void initTrackerServers(List<TrackerServer> serverList) {
    TrackerServer server = new TrackerServer(new ServerBootstrap(),
      ...
      protected void addSpecificHandlers(ChannelPipeline pipeline) {
        ...
        pipeline.addLast("objectDecoder", new MeitrackProtocolDecoder(
            MeitrackProtocol.this));
      }
    };
