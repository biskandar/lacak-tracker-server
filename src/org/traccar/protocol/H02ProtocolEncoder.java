...
public class H02ProtocolEncoder extends StringProtocolEncoder {
  ...
  private Object formatCommand(DateTime time, String uniqueId, String type,
      String... params) {
    
    StringBuilder result = new StringBuilder(String.format(
        "*%s,%s,%s,%02d%02d%02d", MARKER, uniqueId, type, time.getHourOfDay(),
  ...
  protected Object encodeCommand(Command command, DateTime time) {
    ...
    case Command.TYPE_ENGINE_STOP:
      return formatCommand(time, uniqueId, "S20", "1", "3", "10", "3", "5",
          "5", "3", "5", "3", "5", "3", "5");
    case Command.TYPE_ENGINE_RESUME:
      return formatCommand(time, uniqueId, "S20", "0", "0");
    case Command.TYPE_POSITION_PERIODIC:
      return formatCommand(time, uniqueId, "S71", "22", command.getAttributes()
          .get(Command.KEY_FREQUENCY).toString());
    default:
