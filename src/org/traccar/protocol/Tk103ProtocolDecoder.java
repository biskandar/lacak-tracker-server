  ...
  protected Object decode(Channel channel, SocketAddress remoteAddress,
    ...
    if (alarm != -1) {
      position.set(Position.KEY_ALARM,
          Integer.parseInt(sentence.substring(alarm + 4, alarm + 5)));
    }
    ...
    if (status != null) {
      ...
      int value = Integer.parseInt(new StringBuilder(status).reverse()
          .toString(), 2);
