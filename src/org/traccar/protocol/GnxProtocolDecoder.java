...
public class GnxProtocolDecoder extends BaseProtocolDecoder {
  ...
  protected Object decode(Channel channel, SocketAddress remoteAddress,
    ...
    dateBuilder = new DateBuilder(TimeZone.getTimeZone("GMT+5:30")).setTime(
        parser.nextInt(), parser.nextInt(), parser.nextInt()).setDateReverse(
    ...
    position
        .setLatitude(parser.nextCoordinate(Parser.CoordinateFormat.DEG_HEM));
