...
public class WondexProtocol extends BaseProtocol {
  ...
  public WondexProtocol() {
    super("wondex");
    setSupportedCommands(Command.TYPE_REBOOT_DEVICE,
        Command.TYPE_POSITION_SINGLE, Command.TYPE_IDENTIFICATION);
  }
  ...
  public void initTrackerServers(List<TrackerServer> serverList) {
    serverList.add(new TrackerServer(new ServerBootstrap(), this.getName()) {
      ...
      protected void addSpecificHandlers(ChannelPipeline pipeline) {
        ...
        pipeline.addLast("objectDecoder", new WondexProtocolDecoder(
            WondexProtocol.this));
      }
    });
