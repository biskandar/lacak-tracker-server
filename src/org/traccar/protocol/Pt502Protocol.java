...
public class Pt502Protocol extends BaseProtocol {
  ...
  public Pt502Protocol() {
    super("pt502");
    setSupportedCommands(Command.TYPE_SET_TIMEZONE, Command.TYPE_ALARM_SPEED,
        Command.TYPE_OUTPUT_CONTROL, Command.TYPE_REQUEST_PHOTO);
  }
  ...
  public void initTrackerServers(List<TrackerServer> serverList) {
    TrackerServer server = new TrackerServer(new ServerBootstrap(),
      ...
      protected void addSpecificHandlers(ChannelPipeline pipeline) {
        ...
        pipeline.addLast("objectDecoder", new Pt502ProtocolDecoder(
            Pt502Protocol.this));
      }
    };
