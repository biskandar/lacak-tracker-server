...
public class Tt8850ProtocolDecoder extends BaseProtocolDecoder {
  ...
  private static final Pattern PATTERN = new PatternBuilder().binary("0004,")
      .number("xxxx,").expression("[01],").expression("GT...,")
      .number("(?:[0-9A-Z]{2}xxxx)?,") // protocol version
      .expression("([^,]+),") // imei
      .any().number("(d{1,2})?,") // gps accuracy
