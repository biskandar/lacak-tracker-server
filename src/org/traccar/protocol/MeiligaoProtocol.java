...
public class MeiligaoProtocol extends BaseProtocol {
  ...
  public MeiligaoProtocol() {
    ...
    setSupportedCommands(Command.TYPE_POSITION_SINGLE,
        Command.TYPE_POSITION_PERIODIC, Command.TYPE_ENGINE_STOP,
        Command.TYPE_ENGINE_RESUME, Command.TYPE_ALARM_GEOFENCE,
        Command.TYPE_SET_TIMEZONE, Command.TYPE_REBOOT_DEVICE);
  }
  ...
  public void initTrackerServers(List<TrackerServer> serverList) {
    serverList.add(new TrackerServer(new ServerBootstrap(), this.getName()) {
      ...
      protected void addSpecificHandlers(ChannelPipeline pipeline) {
        ...
        pipeline.addLast("objectDecoder", new MeiligaoProtocolDecoder(
            MeiligaoProtocol.this));
      }
    });
