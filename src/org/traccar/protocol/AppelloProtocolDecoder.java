...
public class AppelloProtocolDecoder extends BaseProtocolDecoder {
  ...
  private static final Pattern PATTERN = new PatternBuilder().text("FOLLOWIT,") // brand
      .number("(d+),") // imei
      .groupBegin().number("(dd)(dd)(dd)") // date
      .number("(dd)(dd)(dd).?d*,") // time
      .or().text("UTCTIME,").groupEnd().number("(-?d+.d+),") // latitude
