...
public class ApelProtocolDecoder extends BaseProtocolDecoder {
  ...
  protected Object decode(Channel channel, SocketAddress remoteAddress,
    ...
    if (type == MSG_TRACKER_ID_EXT) {
      ...
      identify(buf.readBytes(length).toString(StandardCharsets.US_ASCII),
      ...
      for (int j = 0; j < recordCount; j++) {
        ...
        if (type == MSG_LOG_RECORDS) {
          ...
          if (subtype != MSG_CURRENT_GPS_DATA
              && subtype != MSG_STATE_FULL_INFO_T104) {
