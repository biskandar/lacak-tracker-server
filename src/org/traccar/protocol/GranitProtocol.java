...
public class GranitProtocol extends BaseProtocol {
  ...
  public GranitProtocol() {
    super("granit");
    setSupportedCommands(Command.TYPE_IDENTIFICATION,
        Command.TYPE_REBOOT_DEVICE, Command.TYPE_POSITION_SINGLE);
  }
  ...
  public void initTrackerServers(List<TrackerServer> serverList) {
    TrackerServer server = new TrackerServer(new ServerBootstrap(),
      ...
      protected void addSpecificHandlers(ChannelPipeline pipeline) {
        ...
        pipeline.addLast("objectDecoder", new GranitProtocolDecoder(
            GranitProtocol.this));
      }
    };
