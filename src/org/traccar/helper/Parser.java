...
public class Parser {
  ...
  public enum CoordinateFormat {
    DEG_DEG, DEG_HEM, DEG_MIN_MIN, DEG_MIN_HEM, DEG_MIN_MIN_HEM, HEM_DEG_MIN_MIN, HEM_DEG, HEM_DEG_MIN, HEM_DEG_MIN_HEM
  }
  ...
  public double nextCoordinate(CoordinateFormat format) {
    ...
    if (hemisphere != null
        && (hemisphere.equals("S") || hemisphere.equals("W") || hemisphere
            .equals("-"))) {
