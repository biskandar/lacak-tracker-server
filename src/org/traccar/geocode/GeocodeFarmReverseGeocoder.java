...
public class GeocodeFarmReverseGeocoder extends JsonReverseGeocoder {
  ...
  public GeocodeFarmReverseGeocoder(String key, int cacheSize) {
    super(URL + "?lat=%f&lon=%f&country=us&lang=en&count=1&key=" + key,
        cacheSize);
  }
  ...
  public Address parseAddress(JsonObject json) {
    ...
    JsonObject result = json.getJsonObject("geocoding_results")
        .getJsonArray("RESULTS").getJsonObject(0).getJsonObject("ADDRESS");
